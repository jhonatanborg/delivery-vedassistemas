...
<body>
    ...
    <div class="container">
        <div id="montar-prato" data-ft style="display: none;" class="mt-1">
            <nav class="nav-pedido">
                ...
                <a href="#mangust" class=""><span>Escolha o Sabor</span></a>
                <a href="#mangust" class=""><span>Escolha Adicionais</span></a>
            ...
            <div class="mb-4">
                <div>
                    <form id="fazerPedido" action="<?php echo $redirecionar->processaPedido ?>" method="POST">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <?php $produtos->listarProdutosPedido('cad_produto', '4'); ?>
                        </ul>
                </div>
                <div>
                    <ul class="list-group list-group-flush">
                        <!-- LISTAR A MASSA -->
                        <?php $produtos->listarProdutosPedido('cad_ingrediente', '8'); ?>
                </div>
                <div>
                    <ul class="list-group list-group-flush">
                        <!-- LISTAR ADICIONAIS -->
                ...
                <div class="d-flex justify-content-end">
                    <button id="confirmar_pedido" type="submit" name="confirmar-caldo" class="btn btn-danger mt-3">Confirmar pedido</button>
                </div>
            </div>
    ...
    <script>
        ...
        $('.caldoSabor').on('change', function() {
            if ($('.caldoSabor:checked').length > 2) {
                this.checked = false;
            }
        });
    </script>
